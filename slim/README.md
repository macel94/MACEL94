...
## SKILLS
Azure, Azure DevOps, GitHub Actions, GitHub Enterprise, Bicep, Infrastructure as Code (IaC), CI/CD, PowerShell, .NET, C#, APIs, Microservices, Azure Kubernetes Service (AKS), Docker, Helm, Prometheus, Grafana, JMeter, Chaos Mesh, Azure Load Testing, Microsoft Entra ID, Azure Key Vault, Managed Identity, RBAC, DevSecOps, SQL, Elasticsearch, Blazor, Microsoft Dynamics 365, Microsoft Business Central, Microsoft Power Platform, Microsoft Fabric, Git, Kubernetes

## EXPERIENCE
### Senior Site Reliability Engineer | Würth IT Italy
Parma, Italy | September 2024 - Present
...
- Led administration and governance for tenants and repos (Azure, Entra ID, Business Central, Fabric, GitHub Enterprise), enforcing DevSecOps guardrails, RBAC, and compliance by default.

### Presales Solutions Architect | Agic Cloud
Parma, Italy | July 2023 - July 2024
...
### Backend Team Leader & Cloud Developer | Agic Cloud
Parma, Italy | February 2022 - July 2023
...
- Built proof of concepts and technical demonstrations using Bicep, Blazor, .NET, Azure DevOps, and GitHub Actions.
...
### Earlier Experience
- Backend Team Leader & Cloud Developer | Vetrya | Parma, Italy | June 2021 - January 2022
- Backend Developer/ Analyst | Credemtel SpA | Reggio nell'Emilia, Italy | April 2020 - May 2021
- Backend Developer | Credemtel SpA | Reggio Emilia, Italy | September 2019 - March 2020
- Consultant - Backend Developer | Amaris | Reggio Emilia, Italy | September 2018 - August 2019
- Junior Backend Developer | ericsoft srl | Misano Adriatico, Italy | May 2016 - August 2018

## CERTIFICATIONS
- Microsoft Certified: Azure Administrator Associate (January 2024)
- Microsoft Certified: DevOps Engineer Expert (October 2021)
- Microsoft Certified: Azure Developer Associate (May 2021)

## EDUCATION
- Bachelor's Degree in Applied Computer Science, Università degli Studi di Urbino 'Carlo Bo' (June 2020)

## LANGUAGES
English - Full professional proficiency; Italian - Native or bilingual proficiency
